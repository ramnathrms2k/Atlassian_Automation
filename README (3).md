...
- **[gto-ATL-Jira-ops-center](gto-ATL-Jira-ops-center/)** - Unified operations center consolidating multiple Jira automation frameworks (Health Dashboard, Response Tracker, Preflight Validator, Script Executor) with multi-instance support for managing multiple Jira environments from a single interface
...
├── gto-ATL-Jira-ops-center/          # Unified Jira operations center with multi-instance support
