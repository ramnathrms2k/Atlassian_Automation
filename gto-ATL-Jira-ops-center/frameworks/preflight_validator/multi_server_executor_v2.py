...
# ===== CONFIGURATION =====
SERVERS = [
    {'name': 'Jira Node 1', 'host': 'jira-lvnv-it-101.lvn.broadcom.net', 'user': 'svcjira'},
    {'name': 'Jira Node 2', 'host': 'jira-lvnv-it-102.lvn.broadcom.net', 'user': 'svcjira'},
    {'name': 'Jira Node 3', 'host': 'jira-lvnv-it-103.lvn.broadcom.net', 'user': 'svcjira'},
]
